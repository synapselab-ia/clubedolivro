...
- síntese breve sem excesso de recontagem;
- tese crítica central;
- pontos fortes;
- limitações/críticas;
...
### Em 30 segundos
Resumo essencial da obra.

### O que realmente importa
3–7 pontos centrais.

### Personagens que preciso lembrar
Lista curta com papel e arco.
...
Perguntas devem:
- admitir mais de uma resposta razoável;
- estar ligadas à obra concreta;
- permitir uso de evidência textual;
- evitar perguntas escolares puramente factuais.

Preferir questões sobre motivação, ambiguidade, estrutura, escolhas do autor, ética, mudança de personagem, símbolos e interpretações rivais.

## 5. `final/DEEP_DIVE.md` — opcional

Versão extensa integrando análise estrutural, temática e crítica para consulta futura.

## Controle final de qualidade

Antes de marcar `COMPLETE`, verificar:
